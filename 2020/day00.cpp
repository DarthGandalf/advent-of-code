...
static void drawRandomPixels(sdl::Renderer& renderer, sdl::Surface& surface,
                             sdl::Texture& tex) {
	{
...
namespace aoc2020 {
Solver::Solver() { m_vis.emplace(300, 200); }
...
void Solver::part2(std::string_view x) { std::cout << x << std::endl; }
}  // namespace aoc2020
